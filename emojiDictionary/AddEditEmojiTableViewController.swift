...
class AddEditEmojiTableViewController: UITableViewController {
    ...
    func updateSaveButtonState() {
        ...
        saveButton.isEnabled = containsSingleEmoji(symbolTextField) && !nameText.isEmpty && !description.isEmpty && !usage.isEmpty
    }
    
    func containsSingleEmoji(_ textField: UITextField
    ) -> Bool {
